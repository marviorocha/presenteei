...
<footer class="bg-gray-700 body-font mt-16">
    <Warp>
        <div
        ...
        >
            ...
            >
                © 2021 PresenteEI — Ideias para Presente
                <a
                    href="https://twitter.com/marviorocha"
                    class="text-gray-500 ml-1 hover:text-gray-300"
            ...
            >
                ...
                <a class="ml-3 text-gray-500 hover:text-gray-300">
                    <svg
                        fill="currentColor"
                        stroke-linecap="round"
                        stroke-linejoin="round"
