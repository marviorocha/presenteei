...
export const categorias = async (keywords) => {
    ...
    let Lomadee = await fetch(`https://${import.meta.env.VITE_URL}/${import.meta.env.VITE_TOKEN}/category/_search?sourceId=${source_id}&keyword=${keywords}`).catch(error => console.log(error))
